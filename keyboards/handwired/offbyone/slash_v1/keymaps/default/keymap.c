...
KC_LCTL, KC_LGUI, KC_LALT,      MO(_LL),  KC_SPC,        MO(_RL), KC_BSPC,   KC_RALT, KC_DEL, KC_RCTL, KC_APP,  KC_LEFT, KC_DOWN, KC_RGHT
    ...
    [_RL] = LAYOUT(
KC_TRNS,  KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,        KC_KB_MUTE, KC_KB_VOLUME_DOWN, KC_KB_VOLUME_UP,  KC_MPLY, KC_MPRV, KC_MNXT, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS,
...
KC_TRNS, KC_TRNS, KC_TRNS,        KC_NO, KC_NO,   KC_TRNS, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_NO, KC_NO, KC_NO
    ...
    [_LL] = LAYOUT(
KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,        KC_NO, KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NUM_LOCK, KC_NO,
